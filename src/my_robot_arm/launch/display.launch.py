...
def generate_launch_description():
    pkg_share = Path(launch_ros.substitutions.FindPackageShare(package='my_robot_arm').find('my_robot_arm'))
    default_model_path = pkg_share / 'urdf/my_robot_arm.urdf.xacro'
